...
<div class="col-md-10 content-pane">
    <h3 class="title-header" style="text-transform: uppercase;">
        ...
        {{$titulo}}
        <a href="{{url('citas/nuevo')}}" class="btn btn-sm btn-success float-right" style="margin-left:10px;"><i class="fa fa-plus"></i> CREAR CITAS</a>
    </h3>
    <div class="row">
        <div class="col-12">
                <!-- inicio card  -->
                                    ...
                                    <td>
                                        <div class="dropdown">
                                          ...
                                          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="{{url('citas/por_fecha/'.Crypt::encryptString($item->cdi_fecha))}}" title="Ver fichas de esta fecha"><i class="fa fa-eye"></i> Ver fichas</a>
                                            @if (-1 > 0)
                                            ...
                                            @else
                                            <a class="dropdown-item btn-eliminar-item" data-id="{{$item->cdi_fecha}}" data-descripcion="{{$item->cdi_fecha}}" data-toggle="modal" data-target="#modal-eliminar-citas-disponibles" href="#"><i class="fa fa-trash"></i> Eliminar</a>
                                            @endif
                                          </div>
                                        </div>
                                    </td>
