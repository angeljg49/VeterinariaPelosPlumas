...
<div class="col-md-10 content-pane">
    <h3 class="title-header" style="text-transform: uppercase;">
        ...
        {{$titulo}}
        <a href="{{url('vacunas/'.Crypt::encryptString($mas_id).'/aplicar')}}" class="btn btn-sm btn-success float-right" style="margin-left:10px;"><i class="fa fa-plus"></i> Aplicar vacuna</a>
    </h3>
                            ...
                            <table class="table table-bordered tabla-datos">
                                ...
                                <tr>
                                    <td class="text-center">
                                        {{$item->vacuna->vac_nombre}}
                                    </td>
                                    <td class="text-center">
                                        {{$item->vap_fecha}}
                                    </td>
                                    <td class="text-center">
                                        {{$item->vap_observaciones}}
                                    </td>
                                    <td>
                                        <div class="dropdown">
                                          ...
                                          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item btn-eliminar-item" data-id="{{$item->vap_id}}" data-descripcion="Vacuna {{$item->vacuna->vac_nombre}} aplicada en fecha {{$item->vap_fecha}}" data-toggle="modal" data-target="#modal-eliminar-vacuna-aplicada" href="#"><i class="fa fa-trash"></i> Eliminar</a>
                                          </div>
                                        </div>
                                    </td>
                                </tr>
...
<div class="modal fade" id="modal-eliminar-vacuna-aplicada" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <form id="form-eliminar-item" action="{{url('vacunasdelete_aplicada')}}" data-simple-action="{{url('vacunas/delete_aplicada')}}" method="post">
            @method('delete')
            @csrf
