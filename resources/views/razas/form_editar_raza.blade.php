			...
			<div class="col-md-12">
				...
				<div class="card">
					<div class="row no-gutters">
						<div class="col-md-12">
							<div class="card-body">
								<form id="form-nuevo-raza" action="{{url('razas/'.$raza->raz_id)}}" method="POST">
								  @csrf
								  @method('PUT')
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group">
														...
														<input required type="text" value="{{old('raz_nombre', $raza->raz_nombre)}}" class="form-control @error('raz_nombre') is-invalid @enderror" name="raz_nombre" id="raz_nombre" placeholder="Nombre de raza" autofocus>
														@error('raz_nombre')
												...
												<div class="col-md-12">
													<div class="form-group">
															...
															<select required class="form-control @error('esp_id') is-invalid @enderror" name="esp_id" id="esp_id">
																...
																<option value="{{$item->esp_id}}" {{ old('esp_id', $raza->esp_id) == $item->esp_id ? 'selected' : '' }}>{{$item->esp_nombre}}</option>
																@endforeach
															</select>
															@error('esp_id')
															<div class="invalid-feedback">
