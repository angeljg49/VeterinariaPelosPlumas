...
<div class="col-md-10 content-pane">
		...
		<div class="alert alert-secondary" role="alert">
			<div className="row">
				<div class="col-md-12 text-center"><strong class="text-success">CONSULTA CON CITA RESERVADA: </strong>{{$cita->cit_fecha_hora_reserva}}</div>
			</div>
		</div>    
										...
										<div class="col-md-12">
											...
											<div class="row">
												<div class="col-md-6">
													...
													<input type="hidden" name="cit_id" value="{{$cita->cit_id}}">
