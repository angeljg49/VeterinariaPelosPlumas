			...
			<div class="col-md-12">
				...
				<div class="card">
					<div class="row no-gutters">
						<div class="col-md-12">
							<div class="card-body">
								<form id="form-nuevo-veterinario" action="{{url('veterinarios/'.$veterinario->vet_id)}}" method="POST">
								  @csrf
								  @method('PUT')
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group">
															...
															Nombre de la veterinario:
															<span class="text-danger">*</span>
															<i class="fa fa-question-circle float-right" title="Establecer el nombre de la veterinario"></i>
															</label>
														<input required type="text" value="{{old('vet_nombre', $veterinario->vet_nombre)}}" class="form-control @error('vet_nombre') is-invalid @enderror" name="vet_nombre" id="vet_nombre" placeholder="Nombre veterinario">
														@error('vet_nombre')
