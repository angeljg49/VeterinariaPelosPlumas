...
<div class="col-md-10 content-pane">
    <h3 class="title-header" style="text-transform: uppercase;">
        ...
        {{$titulo}}
        <a href="{{url('veterinarios/nuevo')}}" class="btn btn-sm btn-success float-right" style="margin-left:10px;"><i class="fa fa-plus"></i> NUEVA veterinario</a>
    </h3>
    <div class="row">
        <div class="col-12">
                <!-- inicio card  -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-info">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>
                                        NO se tienen veterinarios registradas hasta el momento.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered tabla-datos">
                                <thead>
                                <tr>
                                    <th>NOMBRE DEL MEDICO VETERINARIOS</th>
                                    <th>OPCION</th>
                                </tr>
                                </thead>
                                <tbody>
